...
Vehicle::~Vehicle() {
	delete m_pAnimation;  // That is why rule of five is implemented
}
...
Vehicle::Vehicle(const Vehicle& other) :
	...
	m_pAnimation = new Animation{};  // Deep copy
...
Vehicle& Vehicle::operator=(const Vehicle& other) {
	if (this != &other) {
		...
		m_HitPoints = other.m_HitPoints;
		m_Position = other.m_Position;
		// Because the Animation object pointed already exists
		m_pAnimation->SetAnimationData(other.GetAnimation());
	}
	return *this;
}
...
Vehicle& Vehicle::operator=(Vehicle&& other) noexcept {
	if (this != &other) {
		...
		m_HitPoints = other.m_HitPoints;
		m_Position = other.m_Position;
		delete m_pAnimation;  // Free pointed memory before
		m_pAnimation = other.m_pAnimation;
